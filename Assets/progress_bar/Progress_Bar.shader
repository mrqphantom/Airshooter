...
Shader "AmplifiShader/progress_bar"
{
	Properties
	{
		...
		_progressing_control("progressing_control", Range( 0 , 1)) = 0.7896493
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float4 blendOpSrc470 = float4( 0,0,0,0 );
				float4 blendOpDest470 = tex2D( _Texture0, texCoord460 );
				...
				float4 lerpBlendMode470 = lerp(blendOpDest470,(( blendOpDest470 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest470 ) * ( 1.0 - blendOpSrc470 ) ) : ( 2.0 * blendOpDest470 * blendOpSrc470 ) ),( 1.0 - tex2DNode3.a ));
				float4 temp_output_470_0 = ( saturate( lerpBlendMode470 ));
				float4 color455 = IsGammaSpace() ? float4(0,0.7722802,1,1) : float4(0,0.5579053,1,1);
				float temp_output_433_0 = sin( ( _Time.y * 10.78 ) );
				float clampResult496 = clamp( temp_output_433_0 , 0.5 , 0.8 );
				float4 temp_cast_4 = (clampResult496).xxxx;
				float4 blendOpSrc497 = color455;
				float4 blendOpDest497 = temp_cast_4;
				float4 blendOpSrc488 = temp_output_470_0;
				float4 blendOpDest488 = ( temp_output_470_0 + ( saturate( (( blendOpDest497 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest497 ) * ( 1.0 - blendOpSrc497 ) ) : ( 2.0 * blendOpDest497 * blendOpSrc497 ) ) )) );
				float4 lerpBlendMode488 = lerp(blendOpDest488,max( blendOpSrc488, blendOpDest488 ),tex2DNode3.a);
				...
				float4 tex2DNode94 = tex2D( _Wave, lerpResult151.rg );
				float4 blendOpSrc494 = ( ( saturate( lerpBlendMode488 )) + tex2DNode94 );
				float4 blendOpDest494 = float4( 0,0,0,0 );
				float4 lerpBlendMode494 = lerp(blendOpDest494,max( blendOpSrc494, blendOpDest494 ),tex2DNode3.a);
				...
				float4 temp_cast_7 = (( 0.25 * clampResult447 )).xxxx;
				...
				float2 temp_cast_8 = (temp_output_180_0).xx;
				float2 texCoord204 = IN.texcoord.xy * float2( 4.54,10.08 ) + temp_cast_8;
				...
				float4 temp_cast_9 = (tex2DNode72.a).xxxx;
				float4 temp_cast_10 = (tex2DNode72.a).xxxx;
				float4 blendOpSrc57 = temp_cast_10;
				float4 blendOpDest57 = tex2DNode3;
				float4 blendOpSrc86 = temp_cast_9;
				...
				float lerpResult170 = lerp( 0.0 , tex2DNode94.a , temp_output_137_0);
				...
				float4 blendOpSrc443 = temp_cast_7;
				...
				half4 color = ( _Shield == 1.0 ? ( saturate( lerpBlendMode494 )) : ( ( _Hit == 1.0 ? color452 : float4( 0,0,0,0 ) ) + ( saturate( lerpBlendMode443 )) ) );
...
/*ASEBEGIN
Version=18800
-1195.333;882;1280;492;-3904.544;3453.948;1.271291;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;23;2360.388,-2758.41;Float;False;Property;_progressing_control;progressing_control;0;0;Create;True;0;0;0;False;0;False;0.7896493;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;482;2959.217,-3580.175;Inherit;True;Property;_Texture0;Texture 0;8;0;Create;True;0;0;0;False;0;False;f3989d7d8be5c8647a2f51a4cae6d14b;f3989d7d8be5c8647a2f51a4cae6d14b;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;4;-178.3467,82.60919;Float;True;Property;_WaterLevel;WaterLevel;1;0;Create;True;0;0;0;False;0;False;efc27c14ce034c646a14edcee1190a04;efc27c14ce034c646a14edcee1190a04;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexelSizeNode;476;3199.975,-3778.397;Inherit;False;-1;1;0;SAMPLER2D;;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;477;3519.968,-3827.935;Inherit;True;3;3;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;464;2982.205,-3215.885;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;461;2962.743,-3366.982;Inherit;False;Constant;_Vector1;Vector 1;9;0;Create;True;0;0;0;False;0;False;0,0.2;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.ComponentMaskNode;479;3826.364,-3788.164;Inherit;True;True;True;True;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SinOpNode;433;4441.686,-2787.3;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.BlendOpsNode;86;1202.117,-218.9544;Inherit;True;Screen;True;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0.23;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;465;3330.205,-3277.885;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.BlendOpsNode;61;1841.576,-1476.072;Inherit;True;Overlay;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;480;3815.144,-3332.798;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT2;0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SamplerNode;94;3380.192,-2350.416;Inherit;True;Property;_TextureSample0;Texture Sample 0;3;0;Create;True;0;0;0;False;0;False;-1;a38392873d7aedd47be4267bc5ec4e17;a38392873d7aedd47be4267bc5ec4e17;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;362;1375.209,-3033.781;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;460;4171.547,-3457.742;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OneMinusNode;486;4402.329,-3325.877;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;496;4591.042,-2867.247;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;0.8;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;455;4280.445,-2991.1;Float;False;Constant;_Color5;Color 5;6;0;Create;True;0;0;0;False;0;False;0,0.7722802,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;458;4369.595,-3673.091;Inherit;True;Property;_Full_energy;Full_energy;8;0;Create;True;0;0;0;False;0;False;-1;None;f3989d7d8be5c8647a2f51a4cae6d14b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.BlendOpsNode;470;4734.038,-3558.428;Inherit;True;Overlay;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0.3;False;1;COLOR;0
Node;AmplifyShaderEditor.BlendOpsNode;497;4849.114,-2972.765;Inherit;True;Overlay;True;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;459;4971.876,-3203.105;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.BlendOpsNode;488;5201.264,-3432.632;Inherit;True;Lighten;True;3;0;COLOR;1,1,1,0;False;1;COLOR;0.9433962,0.9433962,0.9433962,0;False;2;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;491;5318.693,-3058.13;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.BlendOpsNode;494;5616.48,-3179.29;Inherit;True;Lighten;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
...
WireConnection;486;0;3;4
WireConnection;441;0;132;1
WireConnection;496;0;433;0
...
WireConnection;470;1;458;0
WireConnection;470;2;486;0
WireConnection;497;0;455;0
...
WireConnection;488;0;470;0
WireConnection;488;1;459;0
WireConnection;488;2;3;4
WireConnection;491;0;488;0
WireConnection;491;1;94;0
