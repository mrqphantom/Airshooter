	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float4 temp_cast_0 = (clampResult472).xxxx;
				float4 transform478 = mul(unity_ObjectToWorld,float4( IN.ase_texcoord2.xyz , 0.0 ));
				float2 texCoord460 = IN.texcoord.xy * float2( 1,1 ) + ( (( _ScreenParams * transform478 * _TexelSize )).xyzw + float4( ( float2( 0,0.2 ) * _Time.y ), 0.0 , 0.0 ) ).xy;
				float4 blendOpSrc470 = temp_cast_0;
				float4 blendOpDest470 = tex2D( _Texture0, texCoord460 );
				float4 lerpBlendMode470 = lerp(blendOpDest470,(( blendOpSrc470 > 0.5 )? ( blendOpDest470 + 2.0 * blendOpSrc470 - 1.0 ) : ( blendOpDest470 + 2.0 * ( blendOpSrc470 - 0.5 ) ) ),0.3);
				...
				float4 temp_cast_4 = (( 0.25 * clampResult447 )).xxxx;
				...
				float2 temp_cast_5 = (temp_output_180_0).xx;
				float2 texCoord204 = IN.texcoord.xy * float2( 4.54,10.08 ) + temp_cast_5;
				...
				float4 blendOpSrc86 = temp_cast_7;
				...
				float4 blendOpSrc443 = temp_cast_4;
				...
				half4 color = ( _Shield == 1.0 ? ( ( saturate( lerpBlendMode470 )) + color455 ) : ( ( _Hit == 1.0 ? color452 : float4( 0,0,0,0 ) ) + ( saturate( lerpBlendMode443 )) ) );
...
/*ASEBEGIN
Version=18800
0;0;1920;1019;-2345.957;4130.702;1.3;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;104;-1146.881,-433.5386;Float;True;Property;_Wave;Wave;3;0;Create;True;0;0;0;False;0;False;a38392873d7aedd47be4267bc5ec4e17;a38392873d7aedd47be4267bc5ec4e17;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.BlendOpsNode;57;258.0397,397.8341;Inherit;True;Overlay;True;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0.23;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ScreenParams;474;3156.981,-4012.71;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.WireNode;475;3815.368,-3795.16;Inherit;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;477;3571.369,-3874.059;Inherit;True;3;3;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;482;2852.217,-3600.175;Inherit;True;Property;_Texture0;Texture 0;9;0;Create;True;0;0;0;False;0;False;None;f3989d7d8be5c8647a2f51a4cae6d14b;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.BlendOpsNode;470;4417.791,-3308.735;Inherit;True;LinearLight;True;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0.3;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;459;4622.496,-3120.122;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.Compare;456;4896.447,-2813.607;Inherit;True;0;4;0;FLOAT;0;False;1;FLOAT;1;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.Vector2Node;468;3458.791,-3408.735;Inherit;False;Constant;_Vector15;Vector 15;9;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;55;5326.074,-2447.413;Float;False;True;-1;2;ASEMaterialInspector;0;6;AmplifiShader/progress_bar;5056123faa0c79b47ab6ad7e8bf059a4;True;Default;0;0;Default;2;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;2;False;-1;True;True;True;True;True;0;True;-9;False;False;False;True;True;0;True;-5;255;True;-8;255;True;-7;0;True;-4;0;True;-6;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;0;False;-1;False;True;5;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;CanUseSpriteAtlas=True;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;0;;0;0;Standard;0;0;1;True;False;;False;0
...
WireConnection;456;2;459;0
WireConnection;456;3;450;0
WireConnection;55;0;456;0
ASEEND*/
//CHKSM=1131F5432FB9F07D903CD71AD0D30B484A46BCC1