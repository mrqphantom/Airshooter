	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float4 temp_cast_0 = (( 0.25 * clampResult447 )).xxxx;
				...
				float2 temp_cast_1 = (temp_output_180_0).xx;
				float2 texCoord204 = IN.texcoord.xy * float2( 4.54,10.08 ) + temp_cast_1;
				...
				float4 blendOpSrc86 = temp_cast_3;
				...
				float4 clampResult449 = clamp( ( color440 * sin( ( _Time.y * 10.78 ) ) ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				...
				float4 blendOpSrc443 = temp_cast_0;
				...
				half4 color = ( _Shield == 1.0 ? color455 : ( ( _Hit == 1.0 ? color452 : float4( 0,0,0,0 ) ) + ( saturate( lerpBlendMode443 )) ) );
...
/*ASEBEGIN
Version=18800
-1322.333;243;1279;560;-3530.063;3044.205;1.35001;True;False
...
Node;AmplifyShaderEditor.SinOpNode;433;3047.305,-740.8251;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;439;3208.406,-941.5847;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.BlendOpsNode;438;3088.979,-1413.879;Inherit;True;Lighten;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0.5;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;455;4125.375,-3000.248;Float;False;Constant;_Color5;Color 0;6;0;Create;True;0;0;0;False;0;False;0,0.7722802,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;456;2;455;0
WireConnection;456;3;450;0
WireConnection;55;0;456;0
ASEEND*/
//CHKSM=A633048C571AEDBDF80C4EE0B085D8A524FD9E32